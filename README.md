[![Build status](https://ci.appveyor.com/api/projects/status/w7wuqj7aut17ieng?svg=true)](https://ci.appveyor.com/project/zuev720/ahj-2-2)
...
![](https://github.com/netology-code/ahj-homeworks/raw/simplification/dom/pic/loading.png)

Обратите внимание, в каком виде выводятся оценки (после точки всегда два символа).

При сортировке по id (по возрастанию):

![](https://github.com/netology-code/ahj-homeworks/raw/simplification/dom/pic/loading-2.png)
